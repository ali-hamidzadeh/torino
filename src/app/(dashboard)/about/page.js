      ...
      <section className={styles.containerText}>
        ...
        <div>
          ...
          <p className={`${styles.description} ${styles.longWidth}`}>
            «تفکر پیشرو» از همان روز اول در تاروپود علی‌بابا بوده و همین مدل
            فکری، ما را به جایگاه رتبه یک سفر بازار گردشگری رسانده است. چیزی که
            برای سال‌های آینده از خودمان انتظار داریم
            ...
            زیست‌بوم، از مهم‌ترین اولویت‌های علی‌بابا در ادامه مسیر است.
          </p>
        </div>
      </section>
    </>
